      ...
      <div className="w-full h-full bg-[#121212] text-white flex flex-col font-sans overflow-hidden pt-6 relative">
        ...
        <div className={clsx("flex-1 overflow-y-auto pb-20 no-scrollbar transition-opacity duration-300 absolute inset-0 pt-6", activeTab === 'inicio' ? "opacity-100 z-10" : "opacity-0 z-0 pointer-events-none")}>
          ...
          <div className="flex gap-3 px-4 overflow-x-auto pb-2 pt-2 snap-x no-scrollbar">
            <div className="bg-[#1f1f1f] rounded-2xl p-3 min-w-[90px] flex flex-col items-center justify-center gap-2 snap-center">
              ...
              <span className="text-[10px] text-gray-300 text-center leading-tight">PDF para<br/>Imagem</span>
            </div>
            <div className="bg-[#1f1f1f] rounded-2xl p-3 min-w-[90px] flex flex-col items-center justify-center gap-2 snap-center">
              <div className="w-10 h-10 rounded-full bg-amber-500/10 flex items-center justify-center">
                <ImageIcon className="w-5 h-5 text-amber-500" />
              </div>
              <span className="text-[10px] text-gray-300 text-center leading-tight">Imagem<br/>para PDF</span>
            </div>
            <div className="bg-[#1f1f1f] rounded-2xl p-3 min-w-[90px] flex flex-col items-center justify-center gap-2 snap-center">
              <div className="w-10 h-10 rounded-full bg-blue-500/10 flex items-center justify-center">
                <FileText className="w-5 h-5 text-blue-500" />
              </div>
              <span className="text-[10px] text-gray-300 text-center leading-tight">Texto para<br/>PDF</span>
            </div>
          </div>
          ...
          <div className="mt-4 px-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-red-500 text-[10px] font-medium cursor-pointer" onClick={() => setActiveTab('ferramentas')}>Ver todas</span>
            </div>
            <div className="grid grid-cols-4 gap-2">
              <div className="bg-[#1f1f1f] border border-gray-800 rounded-xl p-2 flex flex-col items-center justify-center gap-1.5 h-16">
                ...
                <span className="text-[8px] text-gray-400 text-center leading-tight">Compactar<br/>PDF</span>
              </div>
              <div className="bg-[#1f1f1f] border border-gray-800 rounded-xl p-2 flex flex-col items-center justify-center gap-1.5 h-16">
                <CopyPlus className="w-4 h-4 text-green-400" />
                <span className="text-[8px] text-gray-400 text-center leading-tight">Mesclar<br/>PDFs</span>
              </div>
              <div className="bg-[#1f1f1f] border border-gray-800 rounded-xl p-2 flex flex-col items-center justify-center gap-1.5 h-16">
                <Split className="w-4 h-4 text-orange-400" />
                <span className="text-[8px] text-gray-400 text-center leading-tight">Dividir<br/>PDF</span>
              </div>
              <div className="bg-[#1f1f1f] border border-gray-800 rounded-xl p-2 flex flex-col items-center justify-center gap-1.5 h-16">
                <Lock className="w-4 h-4 text-blue-400" />
                <span className="text-[8px] text-gray-400 text-center leading-tight">Proteger<br/>PDF</span>
              </div>
            </div>
          </div>

          <div className="mt-6 px-4">
            <h3 className="font-semibold text-sm mb-6">Rascunhos recentes</h3>
            <div className="flex items-center justify-center">
              <span className="text-[11px] text-gray-500">Nenhum rascunho encontrado.</span>
            </div>
          </div>
        </div>
        ...
        <div className={clsx("flex-1 overflow-y-auto pb-20 no-scrollbar transition-opacity duration-300 absolute inset-0 pt-6", activeTab === 'ferramentas' ? "opacity-100 z-10" : "opacity-0 z-0 pointer-events-none")}>
          <div className="px-4 py-3">
            <h2 className="font-bold text-lg mb-4">Todas as ferramentas</h2>
            <div className="bg-[#1f1f1f] rounded-xl flex items-center px-3 py-2 gap-2 mb-4">
              <Search className="w-4 h-4 text-gray-500" />
              <input type="text" placeholder="Buscar ferramenta" className="bg-transparent border-none outline-none text-xs text-gray-300 placeholder-gray-500 w-full" readOnly />
            </div>
            ...
            <div className="mb-5">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-[11px] font-semibold text-gray-300">Converter e Extrair</h3>
              </div>
              <div className="grid grid-cols-2 gap-2">
                <ToolCard icon={<Scan className="w-4 h-4 text-teal-400" />} title="Digitalizar" />
                <ToolCard icon={<ImageIcon className="w-4 h-4 text-amber-500" />} title="JPG para PDF" />
                <ToolCard icon={<ImageIcon className="w-4 h-4 text-red-400" />} title="PDF para JPG" />
                <ToolCard icon={<FilePlus className="w-4 h-4 text-blue-500" />} title="Criar PDF" />
                <ToolCard icon={<FileText className="w-4 h-4 text-purple-400" />} title="Extrair texto" />
                <ToolCard icon={<Languages className="w-4 h-4 text-blue-400" />} title="Traduzir PDF" />
              </div>
            </div>
            ...
            <div className="mb-2">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-[11px] font-semibold text-gray-300">Editar e Organizar</h3>
              </div>
              <div className="grid grid-cols-2 gap-2">
                <ToolCard icon={<ArrowDownUp className="w-4 h-4 text-blue-400" />} title="Juntar PDFs" />
                <ToolCard icon={<Split className="w-4 h-4 text-orange-400" />} title="Dividir PDF" />
                <ToolCard icon={<Trash2 className="w-4 h-4 text-red-400" />} title="Excluir Páginas" />
                <ToolCard icon={<Grid className="w-4 h-4 text-green-500" />} title="Organizar PDF" />
                <ToolCard icon={<RotateCw className="w-4 h-4 text-blue-400" />} title="Rodar PDF" />
                <ToolCard icon={<ListOrdered className="w-4 h-4 text-purple-400" />} title="Numerar Páginas" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className={clsx("flex-1 overflow-y-auto pb-20 no-scrollbar transition-opacity duration-300 absolute inset-0 pt-6", activeTab === 'favoritos' ? "opacity-100 z-10" : "opacity-0 z-0 pointer-events-none")}>
          <div className="px-4 py-3 h-full flex flex-col">
            <h2 className="font-bold text-lg mb-4">Favoritos</h2>
            <div className="flex-1 flex flex-col items-center justify-center pb-20 opacity-60">
              ...
              <span className="text-[11px] text-gray-400">Nenhum favorito ainda.</span>
            </div>
          </div>
        </div>
        ...
        <div className={clsx("flex-1 overflow-y-auto pb-20 no-scrollbar transition-opacity duration-300 absolute inset-0 pt-6", activeTab === 'arquivos' ? "opacity-100 z-10" : "opacity-0 z-0 pointer-events-none")}>
          <div className="px-4 py-3 h-full flex flex-col">
            <div className="flex items-center justify-between mb-4">
              <h2 className="font-bold text-base">Meus arquivos</h2>
            ...
            <div className="bg-[#1f1f1f] rounded-xl flex items-center px-3 py-2 gap-2 mb-2">
              <Search className="w-4 h-4 text-gray-500" />
              <input type="text" placeholder="Pesquisar PDF..." className="bg-transparent border-none outline-none text-xs text-gray-300 placeholder-gray-500 w-full" readOnly />
            </div>
            ...
            <div className="flex-1 flex flex-col items-center justify-center pb-20 opacity-60">
              ...
              <span className="text-[11px] text-gray-400">Nenhuma pasta ou PDF aqui.</span>
            </div>
          </div>
        </div>
        ...
        <div className="absolute bottom-0 inset-x-0 h-[60px] bg-[#1a1a1a] border-t border-gray-800 flex justify-around items-center px-1 pb-1 z-30">
          <button onClick={() => setActiveTab('inicio')} className="flex flex-col items-center justify-center gap-1 w-16 h-full">
            ...
            <span className={clsx("text-[9px]", activeTab === 'inicio' ? "text-red-500 font-medium" : "text-gray-500")}>Início</span>
          </button>
          <button onClick={() => setActiveTab('ferramentas')} className="flex flex-col items-center justify-center gap-1 w-16 h-full">
            ...
            <span className={clsx("text-[9px]", activeTab === 'ferramentas' ? "text-red-500 font-medium" : "text-gray-500")}>Ferramentas</span>
          </button>
          <button onClick={() => setActiveTab('favoritos')} className="flex flex-col items-center justify-center gap-1 w-16 h-full">
            ...
            <span className={clsx("text-[9px]", activeTab === 'favoritos' ? "text-red-500 font-medium" : "text-gray-500")}>Favoritos</span>
          </button>
          <button onClick={() => setActiveTab('arquivos')} className="flex flex-col items-center justify-center gap-1 w-16 h-full">
            ...
            <span className={clsx("text-[9px]", activeTab === 'arquivos' ? "text-red-500 font-medium" : "text-gray-500")}>Meus arquivos</span>
          </button>
